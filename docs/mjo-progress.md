        ...
        return html`
            <div style="display: flex; flex-direction: column; gap: 2rem;">
                ...
                <div>
                    <h4>Sizes</h4>
                    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                        <mjo-progress value="70" size="small" label="Small" showValue></mjo-progress>
                        <mjo-progress value="70" size="medium" label="Medium" showValue></mjo-progress>
                        <mjo-progress value="70" size="large" label="Large" showValue></mjo-progress>
                    </div>
                </div>
            </div>
        `;
    ...
    render() {
        return html`
            <div style="display: flex; flex-direction: column; gap: 1rem;">
                ...
                <mjo-progress min="0" max="200" value="150" label="Extended Range (0-200)" showValue></mjo-progress>
                <mjo-progress min="1000" max="5000" value="3500" label="Large Numbers (1000-5000)" showValue></mjo-progress>
            </div>
        `;
    }
}
