...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll("mjo-alert").forEach((alert) => {
        alert.addEventListener("alert-will-show", (event: any) => {
            console.log("Alert will show:", event.detail);
        });

        alert.addEventListener("alert-show", (event: any) => {
            console.log("Alert shown:", event.detail);
        });

        alert.addEventListener("alert-will-close", (event: any) => {
        ...
        alert.addEventListener("alert-closed", (event: any) => {
