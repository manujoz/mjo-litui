import { g as AiFillAndroid, i as AiFillApi, f as AiFillApple, j as AiFillAudio, k as AiFillBackward, h as AiFillWindows } from "./index.js";
...
const closeHandle = (ev) => {
    ...
    setTimeout(() => {
        ...
        if (value2) chip.setAttribute("value", value2 ? value2.value : "");
