...
export const getTopInTopPosition = ({ dropDown, container }: { dropDown: DropdownContainer; container: HTMLElement }): number => {
...
export const getTopInBottomPosition = ({ dropDown, container }: { dropDown: DropdownContainer; container: HTMLElement }): number => {
...
export const getTopInMiddlePosition = ({ dropDown, container }: { dropDown: DropdownContainer; container: HTMLElement }): number => {
...
export const getLeftInLeftPosition = ({ dropDown, container }: { dropDown: DropdownContainer; container: HTMLElement }): number => {
...
export const getLeftInCenterPOsition = ({ dropDown, container }: { dropDown: DropdownContainer; container: HTMLElement }): number => {
...
export const getLeftInRightPosition = ({ dropDown, container }: { dropDown: DropdownContainer; container: HTMLElement }): number => {
