        ...
        return html`
            ${this.tooltip
                ? html`<div class="tooltip">
                      <div class="text">${this.valuePrefix}${this.value}${this.valueSuffix}</div>
                  </div>`
                : nothing}
            <div class="outter" ?data-pressed=${this.pressed}><div class="inner" ?data-pressed=${this.pressed}></div></div>
        `;
    }
    ...
    static styles = [
        css`
            ...
            .text {
                ...
                font-size: 0.8em;
                color: white;
                background-color: var(--mjo-slider-color, var(--mjo-primary-color, #007bff));
                border-radius: 5px;
            ...
            .text::after {
                ...
                bottom: -10px;
                left: calc(50% - 5px);
                border-top-color: var(--mjo-slider-color, var(--mjo-primary-color, #007bff));
                content: "";
            }
            .outter {
                position: absolute;
